...
<!-- ket thuc cay -->
 		 ...
 		 <div class="col-md-4 ">
			...
			<ul id="tree-menu">
 			<li><a href="#"><span>+</span>Minh Chứng 1</a>
     		   <ul id="menu-lv1">
            <li>&#8250; <a href="3chitiet_cantin.jsp">Tên mục minh chứng</a></li>
	...
	<div class="center">		
		...
		<img src="img/maylocnuoc.jpg" alt="..." class="">
		<h3>Máy Lọc Nước</h3>
			        <p>Bảo trì: 10 năm</p>
			        <p>Cao: 1 mét</p>
			        <p><a href="" class="btn btn-primary">File đính kèm</a> </p>
			        <p>Người tạo minh chứng :Dương Bình Duy</p>
