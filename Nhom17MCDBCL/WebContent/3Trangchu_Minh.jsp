			  ...
			  <div class="col-sm-5 col-md-4">
			    <div class="thumbnail">
			      ...
			      <div class="chuoi">
			        ...
			        <p><a href="3chitiet_cantin.jsp" id ="div1" class="btn btn-primary" role="button">Chi Tiết</a> </p>
			      </div>
			    </div>
			  </div>
			  ...
			  <div class="col-sm-13 col-md-4">
			    <div class="thumbnail">
			      ...
			      <div class="do">
			        ...
			        <p><a href="3chitiet_thuvien.jsp" class="btn btn-primary" role="button">Chi tiết</a></p>
			      </div>
			    </div>
			  </div>
			  <div class="col-sm-5 col-md-4">
