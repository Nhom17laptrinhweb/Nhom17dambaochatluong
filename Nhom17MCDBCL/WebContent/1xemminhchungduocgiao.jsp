...
<body>
  <div id="wrapper">
    <div id="head">
        ...
        <div class="dangnhap">
          <h4> Chào Sơn</h4>
          <a href="TrangChu_Admin.jsp"></a><input class="btn btn-info" type="button" name="dangxuat" value="Đăng xuất"> <br>
        ...
        <nav class="navbar navbar-default" role="navigation">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="1xemminhchungduocgiao.jsp">Xem Minh Chứng</a>
            </div>
