...
<h1>Sửa Mục Minh Chứng</h1>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Tên Minh Chứng" type="text" value="Căn Tin">
    </div><!-- ten minh chung -->
    <!-- mo ta -->
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Mô Tả" type="text" value="Diện tích: 50m vuông
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Người Nhập" type="text" value="Chưa Nhập">
    </div>
   </div><!-- nguoi nhap -->
   <!-- nguoi tao -->
   <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Người Tạo" type="text" value="Hồ Quang Hiếu">
    </div>
   </div><!-- nguoi tao -->
   
  <div class="col-sm-8 control-label">
      <a href="2suathanhcong2.jsp" ><input type="button" value="Xong" class="btn btn-default"></a>
    </div>
