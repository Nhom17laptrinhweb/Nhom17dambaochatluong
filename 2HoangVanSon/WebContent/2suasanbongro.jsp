...
<h1>Sửa Mục Minh Chứng</h1>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Tên Minh Chứng" type="text" value="Sân Bóng Rổ">
    </div><!-- ten minh chung -->
    <!-- mo ta -->
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Mô Tả" type="text" value="DDiện tích: 500m vuông
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Người Tạo" type="text" value="Đào kim Hùng">
    </div>
   </div><!-- nguoi tao -->
   
  <div class="col-sm-8 control-label">
      <a href="2suathanhcong3.jsp" ><input type="button" value="Xong" class="btn btn-default"></a>
    </div>
