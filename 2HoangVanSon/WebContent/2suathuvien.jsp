...
<h1>Sửa Mục Minh Chứng</h1>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Tên Minh Chứng" type="text" value="Thư Viện">
    </div><!-- ten minh chung -->
    <!-- mo ta -->
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Mô Tả" type="text" value="Diện tích: 700m vuông

      Số khu: 20

      Sách: Hơn 100000 cuốn">
    </div> 
   </div> <!-- mo ta -->
   <!-- file minh chung -->
  <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Người Tạo" type="text" value="Huỳnh Thị Thu Trang">
    </div>
   </div><!-- nguoi tao -->
   
  <div class="col-sm-8 control-label">
      <a href="2suathanhcong4.jsp" ><input type="button" value="Xong" class="btn btn-default"></a>
    </div>
