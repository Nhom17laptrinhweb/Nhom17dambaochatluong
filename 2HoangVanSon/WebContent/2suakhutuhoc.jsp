...
<h1>Sửa Mục Minh Chứng</h1>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Tên Minh Chứng" type="text" value="Khu tự học">
    </div><!-- ten minh chung -->
    <!-- mo ta -->
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Mô Tả" type="text" value="Diện tích : 400m vuông
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input class="form-control" id="Người Nhập" type="text" value="Nguyễn Văn Linh">
    </div>
   </div><!-- nguoi nhap -->
   <!-- nguoi tao -->
   <div class="form-group">
  ...
  <div class="col-sm-8 control-label">
      <a href="2suathanhcong6.jsp" ><input type="button" value="Xong" class="btn btn-default"></a>
    </div>
