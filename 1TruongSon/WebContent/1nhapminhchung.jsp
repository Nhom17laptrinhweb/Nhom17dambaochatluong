...
<body>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="1xemminhchungduocgiao.jsp">Xem Minh Chứng Được Giao</a></li>
  ...
  <div class="col-sm-8 control-label">
      <a href="1nhapthanhcong.jsp" ><input type="button" value="Xong" class="btn btn-default"></a>
    </div>
</center>
